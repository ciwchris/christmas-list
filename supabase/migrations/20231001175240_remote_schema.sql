...
CREATE TABLE IF NOT EXISTS "public"."items" (
    ...
    CONSTRAINT "items_item_check" CHECK (("char_length"("item") > 3))
);
...
CREATE POLICY "Everyone can view items. " ON "public"."items" FOR SELECT TO "anon" USING (true);

CREATE POLICY "Individuals can create items." ON "public"."items" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));

CREATE POLICY "Individuals can delete their own items." ON "public"."items" FOR DELETE USING (("auth"."uid"() = "user_id"));

CREATE POLICY "Individuals can update their own items." ON "public"."items" FOR UPDATE USING (("auth"."uid"() = "user_id"));
